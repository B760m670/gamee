...
enum KeychainStore {
  ...
  /// Removes the item for `account`, if any. Not an error if there was
  /// nothing to remove — "already gone" and "successfully removed" are the
  /// same outcome from the caller's perspective.
